...
\fancyhead[CO]{\footnotesize\textsf{J. Appl. Phys., Vol. 94, No. 12, 15 December 2003\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad}} 
...
\begin{small}
\begin{align*}
	{\qquad}U(\phi,\alpha_\infty)&=\sum_{\theta_{i}}\sum_{t_{i}}[p^r(x,\theta_i,t_i) \nonumber \\
